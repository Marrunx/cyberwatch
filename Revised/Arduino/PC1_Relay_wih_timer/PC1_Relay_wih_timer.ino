...
// Server URLs
const String serverUrl = "http://192.168.0.117/ComputerRental/Revised/function/get_uid_promo_pc1.php"; // Fetch UID and promo
const String resetUrl = "http://192.168.0.117/ComputerRental/Revised/function/reset_promo.php";       // Reset promo
...
void activateRelay(int minutes, String uid) {
  ...
  while (minutes > 0) {
    // Display remaining time in HH:MM format
    int hours = minutes / 60;
    int mins = minutes % 60;
    display.showNumberDecEx(hours * 100 + mins, 0b11100000, true);  // Show HH:MM
