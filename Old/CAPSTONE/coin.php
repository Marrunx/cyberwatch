...
$rite = "<?php $" . "coinrst=''; " . "echo $" . "coinrst;" . "?>";
file_put_contents('coincontainer.php',$rite);
?>
...
<head>
    ...
    <script>
            ...
            $(document).ready(function(){
				 $("#coinrst").load("coincontainer.php");
				setInterval(function() {
					$("#coinrst").load("coincontainer.php");
				}, 500);
			});
    ...
    <center>
        <div class = "customer-info">
            <form action = "" method = "post"> 
                ...
                <label for = "coinrst" class = "cardLoad"> Load </label>
<!--                <input type = "text" id = "cardLoad" name = "cardLoad" required> <br>-->
                <textarea class="UID" id="coinrst" name = "coinrst" placeholder="PLACE THE CARD "  require ></textarea> <br>
